...
### Running Analysis for a Specific Dataset

```bash
python src/analysis/run_all_analysis.py --dataset iris
```

### Skipping Specific Analyses

```bash
# Skip optimization analysis
python src/analysis/run_all_analysis.py --skip-optimization

# Skip profiling analysis
python src/analysis/run_all_analysis.py --skip-profiling

# Skip comprehensive analysis
python src/analysis/run_all_analysis.py --skip-comprehensive
```
...
This will:
- Analyze pruning and quantization results
- Provide insights about model size reduction and accuracy impact
- Generate recommendations for further optimization
- Save report to `reports/iris_optimization_report.md`
...
- Save report to `reports/iris_profiling_report.md`
...
This will:
- Combine optimization and profiling analyses
- Provide deployment strategies
- Generate key insights and recommendations
- Save report to `reports/iris_comprehensive_report.md`
...
- `results/{dataset_name}/` - Contains optimization results
...
- Key insights and further improvement suggestions

### Troubleshooting Analysis Tools
# Process all datasets
python scripts/unified_results_processor.py

# Process specific dataset with memory metrics
python scripts/unified_results_processor.py --dataset iris --memory

# Process specific activation function
python scripts/unified_results_processor.py --activation relu

# Custom output paths
python scripts/unified_results_processor.py --output custom/path/results.csv --report custom/path/report.md